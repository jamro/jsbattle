...
module.exports = function() {
  ...
  describe('Challenges', async () => {
    ...
    it('should win the battle', async function() {
      this.retries(3);
      ...
      await setNavBarSpeed(self.page, '50');
      await setNavBarQuality(self.page, '0');
      await clickChallengeStart(self.page, 0);
      await writeCode(self.page, code);
      await clickFight(self.page);
      await waitForBattlefield(self.page);
      await waitForBattlefieldHide(self.page);
      let hasWon = await hasWonChallenge(self.page)
